    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', fontFamily: 'var(--font-body)' }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          {[
            ...
            `We now support 34 document types across 18 jurisdictions — Nigeria, the UK, Kenya, Ghana, South Africa, the US, Canada, India, UAE, Singapore, and more. Nigerian landlords, Kenyan freelancers, Canadian contractors, Indian consultants — anyone who needs a proper document without paying lawyer rates.`,
          ].map((para, i) => (
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { num: '28', label: 'Document types' },
            { num: '18', label: 'Jurisdictions covered' },
