...
const PLANS = [
  {
    ...
    features: [
      ...
      'WhatsApp extraction',
      'Vigil Fraud Alert — proximity engine (500 authorizations/mo)',
      'Email support',
    ],
    highlight: false,
    badge:     null,
  },
  {
    ...
    features: [
      ...
      'Vigil AI risk scoring (5,000 authorizations/mo)',
  ...
  },
  {
    ...
    features: [
      ...
      'Vigil AML compliance reports (25,000 authorizations/mo)',
      'FieldOps Agent API',
