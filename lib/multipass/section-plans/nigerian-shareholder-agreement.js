...
export const NIGERIAN_SHAREHOLDER_AGREEMENT_TEMPLATE = {
  ...
  sections: [
    ...
    },
    {
      ...
      dependencies: ['sec-2'],
      statute_refs: ['CAMA-S124', 'CAMA-S125', 'CAMA-S140'],
      expected_length: 'medium',
      parallelizable: true,
    },
    {
    ...
    },
    {
      ...
      dependencies: ['sec-2'],
      statute_refs: ['CAMA-S269', 'CAMA-S275'],
    ...
    },
    {
      ...
      dependencies: ['sec-2'],
      statute_refs: ['CAMA-S374', 'NDPA-S37'],
      expected_length: 'medium',
      parallelizable: true,
    },
    {
      ...
      dependencies: ['sec-2'],
      statute_refs: ['NDPA-S25', 'NDPA-S26', 'NDPA-S30', 'NDPA-S40', 'NDPA-S43'],
      expected_length: 'long',
      parallelizable: true,
    },
    {
