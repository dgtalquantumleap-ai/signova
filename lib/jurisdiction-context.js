...
//   - api/scope-guard-analyze.js (free tier, Groq Llama)
...
// Kept compact (< 600 tokens each) so the free-tier Groq Llama path can use
// the same blocks without exceeding context budget.
//
