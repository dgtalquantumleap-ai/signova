...
const JURISDICTION_DISPLAY = {
  ...
  usa_delaware: 'United States — Delaware',
...
Forum: Florida circuit court or federal Northern/Middle/Southern District; Florida Commission on Human Relations.`,
  ...
  usa_delaware: `JURISDICTION CONTEXT — UNITED STATES — DELAWARE
All federal context above PLUS Delaware-specific:
- Delaware General Corporation Law (DGCL), 8 Del. C. §§ 101+ — the canonical US corporate statute. Governs charter, bylaws, board fiduciary duties (Smith v. Van Gorkom; Revlon; Unocal), stockholder rights (§ 211 annual meeting; § 220 books-and-records inspection), mergers (§§ 251–253), appraisal rights (§ 262)
- Delaware LLC Act, 6 Del. C. §§ 18-101+ — preferred for LLC operating agreements; broad freedom of contract under § 18-1101(c) ("the policy of this chapter [is] to give the maximum effect to the principle of freedom of contract"); fiduciary duties may be expanded, restricted, or eliminated except for the implied covenant of good faith and fair dealing
- Delaware Uniform Trade Secrets Act (DUTSA), 6 Del. C. §§ 2001–2009 — adopts the Uniform Trade Secrets Act with Delaware modifications. § 2001 definitions; § 2002 injunctive relief; § 2003 damages (actual loss + unjust enrichment, or reasonable royalty; up to 2x exemplary for willful and malicious); § 2004 attorney's fees (bad faith, willful and malicious); § 2005 preservation of secrecy; § 2006 statute of limitations (3 years from discovery)
- Delaware non-competes — enforceable if reasonable in scope, duration, and geography AND tied to a legitimate business interest. Delaware courts apply a reasonableness test similar to the Restatement (2d) Contracts § 188; blue-pencilling permitted but disfavoured
- Delaware Anti-SLAPP statute, 10 Del. C. § 8137 — narrow; protects statements made before public bodies
- DRULPA / DLLCA — limited partnerships and LLCs, broad freedom-of-contract framework
- Delaware Wage Payment and Collection Act, 19 Del. C. §§ 1101+ — wage payment, final-pay timing, deductions
Forum: Delaware Court of Chancery (equity, corporate disputes — the world's most influential business court; no juries; specialised judges/Vice Chancellors; opinions by Strine, Laster, etc.); Delaware Superior Court (legal disputes, including DUTSA damages claims at law); US District Court for the District of Delaware (federal); Delaware Supreme Court (final appeals).
Currency: USD.`,
